...
/**
 * Every PDFBox fuzz target behind a single entry point.
 *
...
public class FuzzMerged {
  ...
  public static void fuzzerTestOneInput(String data) {
    ...
    switch (data.charAt(0) % TARGETS) {
      case 0:
        PDFExtractTextFuzzer.fuzzerTestOneInput(payload);
        break;
      case 1:
        PDFStreamParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 2:
        TTFParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 3:
        OTFParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 4:
        CFFParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 5:
        CMapParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 6:
        PFAParserFuzzer.fuzzerTestOneInput(payload);
        break;
      case 7:
        PDFWriteReadFuzzer.fuzzerTestOneInput(payload);
        break;
      default:
        break;
    }
