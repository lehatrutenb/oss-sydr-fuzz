...
public class OutputStreamFuzzer {
  ...
  public static void fuzzerTestOneInput(String data) {
    ...
    try {
      ...
      Integer choice = Math.floorMod(selector, 16) + 1;
      ...
      switch (choice) {
        ...
        case 12:
          ...
          break;
        case 13:
          os = new ThresholdingOutputStream(payload.hashCode());
          break;
        case 14:
        ...
        case 16:
          ...
          os =
              WriterOutputStream.builder()
                  ...
                  .setWriteImmediately(StringInputs.flagAt(payload, 0))
                  .get();
          break;
      }
