...
public class TokenParserPersistentFuzzer {
    public static String[] args;

    public static void main(String[] args) {
        TokenParserPersistentFuzzer.args = args;
        fuzzerTestOneInput("");
    }

    public static void fuzzerTestOneInput(String _input) {
        for (String path : TokenParserPersistentFuzzer.args) {
            String input;
            try {
            ...
            try {
                TokenParserFuzzer.fuzzerTestOneInput(input);
            } finally {
